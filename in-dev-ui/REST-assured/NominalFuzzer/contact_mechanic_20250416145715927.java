...
@Order(781)
public class contact_mechanic_20250416145715927{
...
String baseURL ="http://localhost:8888";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_number_of_repeats = 4851356476618931200;
		request0_request_body.put("number_of_repeats" , request0_request_body_number_of_repeats);
		Object request0_request_body_mechanic_api = "antenati";
		request0_request_body.put("mechanic_api" , request0_request_body_mechanic_api);
		Object request0_request_body_vin = "Thomasboro";
		...
		Object request0_request_body_problem_details = "Z@qqy";
		request0_request_body.put("problem_details" , request0_request_body_problem_details);
		Object request0_request_body_mechanic_code = "HC G K";
	...
	@Test
	public void test_contact_mechanic_20250416145715927()  throws JSONException{
		test0();
	}
}
