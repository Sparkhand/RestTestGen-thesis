...
@Order(7842)
public class contact_mechanic_20250416145908228{
...
String baseURL ="http://localhost:8888";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_number_of_repeats = 95.5406;
		request0_request_body.put("number_of_repeats" , request0_request_body_number_of_repeats);
		Object request0_request_body_mechanic_api = "qXVnSNB";
		request0_request_body.put("mechanic_api" , request0_request_body_mechanic_api);
		Object request0_request_body_vin = "http://cololxrpl.co.uk/";
		...
		Object request0_request_body_problem_details = "maxixe";
		request0_request_body.put("problem_details" , request0_request_body_problem_details);
		Object request0_request_body_mechanic_code = "Adam";
	...
	@Test
	public void test_contact_mechanic_20250416145908228()  throws JSONException{
		test0();
	}
}
