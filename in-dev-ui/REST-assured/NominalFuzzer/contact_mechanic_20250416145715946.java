...
@Order(794)
public class contact_mechanic_20250416145715946{
...
String baseURL ="http://localhost:8888";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_number_of_repeats = 103;
		request0_request_body.put("number_of_repeats" , request0_request_body_number_of_repeats);
		Object request0_request_body_mechanic_api = "b923b017-2598-4c1e-a70a-706d857ec57d";
		request0_request_body.put("mechanic_api" , request0_request_body_mechanic_api);
		Object request0_request_body_vin = "drahthaar";
		...
		Object request0_request_body_problem_details = "complines";
		request0_request_body.put("problem_details" , request0_request_body_problem_details);
		Object request0_request_body_mechanic_code = "lpefho@outlook.com";
	...
	@Test
	public void test_contact_mechanic_20250416145715946()  throws JSONException{
		test0();
	}
}
