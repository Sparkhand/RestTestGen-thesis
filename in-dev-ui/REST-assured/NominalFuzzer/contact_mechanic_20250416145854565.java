...
@Order(7075)
public class contact_mechanic_20250416145854565{
...
String baseURL ="http://localhost:8888";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_number_of_repeats = -1483456381728420864;
		request0_request_body.put("number_of_repeats" , request0_request_body_number_of_repeats);
		Object request0_request_body_mechanic_api = "2010/07/30";
		request0_request_body.put("mechanic_api" , request0_request_body_mechanic_api);
		Object request0_request_body_vin = "9876895423";
		...
		Object request0_request_body_problem_details = "desquamating";
		request0_request_body.put("problem_details" , request0_request_body_problem_details);
		Object request0_request_body_mechanic_code = "HK";
	...
	@Test
	public void test_contact_mechanic_20250416145854565()  throws JSONException{
		test0();
	}
}
