...
@Order(3948)
public class contact_mechanic_20250416145812432{
...
String baseURL ="http://localhost:8888";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_number_of_repeats = 37;
		request0_request_body.put("number_of_repeats" , request0_request_body_number_of_repeats);
		Object request0_request_body_mechanic_api = "6b73a58f-8e37-40f1-bd30-f74b06574db1";
		request0_request_body.put("mechanic_api" , request0_request_body_mechanic_api);
		Object request0_request_body_vin = "concussed";
		...
		Object request0_request_body_problem_details = "dk.";
		request0_request_body.put("problem_details" , request0_request_body_problem_details);
		Object request0_request_body_mechanic_code = "salt-and-pepper";
	...
	@Test
	public void test_contact_mechanic_20250416145812432()  throws JSONException{
		test0();
	}
}
