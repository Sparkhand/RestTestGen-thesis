...
@Order(413)
public class create_order_20250416145704535{
...
String baseURL ="http://localhost:8888";
	...
	private void test0() throws JSONException{
		...
		Object request0_request_body_product_id = 717806536;
		request0_request_body.put("product_id" , request0_request_body_product_id);
		Object request0_request_body_quantity = request1_unknown_quantity;
		...
		//Build Response
		Response response0 = request0.when().post(baseURL+"/workshop/api/shop/orders");
		String response0_response_body = response0.getBody().asString();

		Assertions.assertFalse(response0.getStatusCode()>=500,"StatusCode 5xx: The test sequence was not executed successfully.");
	}
	@Test
	public void test_create_order_20250416145704535()  throws JSONException{
		test0();
	}
}
